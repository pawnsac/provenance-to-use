...
void cr_dump_static_init(void) {
	RESET_KCMP_TREE(vm_tree, KCMP_VM);
	RESET_KCMP_TREE(fs_tree, KCMP_FS);
	RESET_KCMP_TREE(files_tree, KCMP_FILES);
	RESET_KCMP_TREE(sighand_tree, KCMP_SIGHAND);
}
