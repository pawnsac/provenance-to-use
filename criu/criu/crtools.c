...
extern void cr_dump_static_init(void);
extern void pstree_static_init(void);
extern void file_ids_static_init(void);
extern void tty_static_init(void);

int criu_main(int argc, char *argv[], char *envp[])
{
	int ret = -1;
